# -*- coding: utf-8 -*-
"""
Created on Mon Jul 19 17:34:06 2021
...
all_result_folders = os.listdir(Path(os.getcwd()))
...
for apply_folder in apply_list: 
    os.chdir(dir_path+'\\'+apply_folder)
    ...
    path_to_main_folder = Path(dir_path+'\\'+apply_folder)
